...
class low_pass_filter_demo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "low_pass_filter_demo")
        ...
        self.frequency = frequency = 8000

        ##################################################
        # Blocks
        ##################################################

        self._frequency_range = Range(0, 16000, 50, 8000, 200)
...
def main(top_block_cls=low_pass_filter_demo, options=None):
