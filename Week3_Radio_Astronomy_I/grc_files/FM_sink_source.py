...
class FM_sink_source(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FM_sink_source")
        ...
        self.freq = freq = 96.9e6
        self.cutoff = cutoff = 0.5e5
        ...
        self._freq_range = Range(85e6, 110e6, 1e5, 96.9e6, 200)
        ...
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:50001', 100, False, (-1), '', False)
...
def main(top_block_cls=FM_sink_source, options=None):
