...
class ex2_nyquist(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ex2_nyquist")
        ...
        self._samp_rate_range = Range(1000, 20000, 100, 16000, 200)
        ...
        self._freq_range = Range(1000, 10000, 100, 1000, 200)
...
def main(top_block_cls=ex2_nyquist, options=None):
